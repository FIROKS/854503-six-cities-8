  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      <div className="reviews__rating-form form__rating">
        <input onChange={({target}: ChangeEvent<HTMLInputElement>) => {setReviewRating(parseInt(target.value, 10));}} className="form__rating-input visually-hidden" name="rating" value="5" id="5-stars" type="radio" />
        ...
        <input onChange={({target}: ChangeEvent<HTMLInputElement>) => {setReviewRating(parseInt(target.value, 10));}}
      ...
      <textarea onChange={({target}: ChangeEvent<HTMLTextAreaElement>) => {setReviewText(target.value);}}
